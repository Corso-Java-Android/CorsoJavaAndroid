...
CREATE TABLE ordini -- generare da 10 a 20 ordini per cliente
   (	
    ID_ORDINE int auto_increment, -- numero progressivo che parte da 1
	DATA DATETIME, --  '2020-MM-GG 00:00:00' MM random compreso tra 1 e 12, GG random compreso tra 5 e 25 
	VALORE decimal(10,2),  -- random compreso tra 10000 e 20000
	ID_CLIENTE int, -- da 1 a 19 (può essere random)
